...
//Amanda Esposito, espositoa2@mailbox.winthrop.edu
//This program will use a merge sort like algorithm to sort input from files or
//the command line.
...
public class sortit
{
    public static void main(String[] args) throws IOException
    {
        ...
        //Boolean duplicates = false; dont need due to unsuccessful functions
        String oneData = "";
        String twoData = "";
        int compare;
        int count1 = 0;
	...
	String S4 = "-u";
        ...
        while(args.length > count)
        {
            ...
            /*else if(fname.equals(S4)) //attempted duplicates check
            {
                duplicates = true;
                count = count+1;
            }*/
        ...
        /*if(reverse == true) //removing duplicates
        {
            if(One.length() > 0)
            {
                One.removeDup();
